Transaction ID<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
<head>
    <meta charset="UTF-8">
    <title>Payment Success | Royal Mahal</title>
...
<div class="container">
    ...
    <div class="main-content">
        <div class="success-container">
            ...
            <p>Your booking has been confirmed. Thank you for choosing Royal Mahal.</p>
                      
            <% if (payment != null) { %>
    <div class="payment-details">
        <p><strong>Account No:</strong> <%= payment.getTransactionId() %></p>
        <p><strong>Amount Paid:</strong> ₹<%= String.format("%.2f", payment.getAmount()) %></p>
        <p><strong>Payment Method:</strong> 
           <%= payment.getPaymentMethodName() != null ? payment.getPaymentMethodName() : "N/A" %></p>
        <p><strong>Date:</strong> 
           <%= payment.getPaymentDate() != null ? dateFormat.format(payment.getPaymentDate()) : "N/A" %></p>
    </div>
<% } %>
            
            <a href="${pageContext.request.contextPath}/BookingController" class="btn btn-primary">
                View My Bookings
            </a>
        </div>
    </div>
