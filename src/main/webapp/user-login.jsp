...
<head>
    ...
    <title>Royal Mahal - User Login</title>
    ...
    <style>
        ...
        * {
        ...
        .login-section {
            ...
            min-height: 80vh;
            padding: 40px 0;
            background-image: url('https://png.pngtree.com/thumb_back/fh260/background/20220601/pngtree-wedding-reception-wedding-restaurant-reception-photo-image_88236.jpg');
        ...
        <div class="container">
            <div class="login-container">
                <div class="login-header">
                    <h2>User Login</h2>
                    <p>Access your account to book venues</p>
                </div>
                ...
                <a href="${pageContext.request.contextPath}/user-register.jsp" class="register-link">
